...
public class TrackingResponseConsumer : IMessageConsumer<TrackingResponse>
{
        ...
        IMessageContext<TrackingResponse> context)
    {
        ...
        {
            execution.ExecutionStatus = message.IsSuccess ? ExecutionStatusType.Successful : ExecutionStatusType.Failed;
            execution.StartedAt = message.StartedAt;
            execution.CompletedAt = message.CompletedAt;

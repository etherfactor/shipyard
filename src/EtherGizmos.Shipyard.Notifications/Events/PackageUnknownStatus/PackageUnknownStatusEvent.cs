...
public record PackageUnknownStatusEvent : ShipyardEvent
{
    ...
    public required ImmutableList<PackageUnknownStatusEventUpdate> Updates { get; init; }
}

public record PackageUnknownStatusEventUpdate
{

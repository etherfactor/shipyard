...
internal class PackageUnknownStatusExtractor : IDomainEventExtractor
{
    ...
    public PackageUnknownStatusExtractor(
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
            ...
            && current != original)
        {
            ...
            var message = $"{package.Carrier.Name} package containing {package.Contents} received an unknown tracking status: {lastUpdate?.Description}."
                .Replace("..", ".");

            var @event = new PackageUnknownStatusEvent()
            {
                ...
                Updates = [.. package.TrackingUpdates.Select(e => new PackageUnknownStatusEventUpdate()
                {

...
public class PackageOutForDeliveryRouter : IDomainEventRouter<PackageOutForDeliveryEvent>
{
    private readonly IUnitOfWorkFactory _uowFactory;

    public PackageOutForDeliveryRouter(
    ...
    public async IAsyncEnumerable<string> FilterScopeAsync(
        PackageOutForDeliveryEvent @event,
